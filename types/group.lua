...
--- @field disabled_change? fun(self: TheFamilyTab, new_value: boolean) Callback when group is enabled/disabled by player in mod config. Ignores `TheFamilyGroup:enabled()`
